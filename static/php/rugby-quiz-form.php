...
if (isset($_POST['inputName']) && isset($_POST['inputEmail'])) {
  ...
  $mail->Body = "<div><p> Name: " . $_POST['inputName'] . "</p><p> Phone: " . stripslashes($_POST['inputPhone']);
  ...
  // saving lead
  save_lead("email=" . $_POST['inputEmail'] . "&name=" . $_POST['inputName'] . "&site=NewBrew&notes=RugbyQuiz");
